            ...
            <div class="col-sm-12 mobile-inputs">
                ...
                ?> 
                        <form method="post">  
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Numero de visitas:</label>
                                <div class="col-sm-10">
                                    <input type="number" name="txtVisitas" class="form-control form-control-round  form-txt-warning" value="<?php echo $datos["num_visitas"] ?>" required>
                                </div>
                            </div>
