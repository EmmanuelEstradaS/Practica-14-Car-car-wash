...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="views/admin_assets/css/animate/animate.min.css">
    ...
    <body class="bg-white">
        ...
        <div id="preloader">
            <div class="canvas">
                <img src="views/admin_assets/img/logo.png" alt="logo" class="loader-logo">
                    ...
                    <div class="authentication-form-2 mx-auto">
                        <div class="tab-content" id="animate-tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane show active" id="singin" aria-labelledby="singin-tab">
                                <h3>Iniciar sesión (Administrador en Car Wash)</h3>
                                <form method="post">
        ...
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="views/admin_assets/js/components/tabs/animated-tabs.min.js"></script>
        <!-- End Page Snippets -->
    </body>
</html>